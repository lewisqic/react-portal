...
class AdminMemberRoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.admin.member-roles.index');
    }
    ...
    {
        $data = RoleService::dataTables(\Request::all(), User::$types[User::MEMBER_ID]['route']);
    ...
    public function create()
    {
        $data = [
            'title' => 'Add',
            'all_permissions' => PermissionService::buildPermissionsList(User::$types[User::MEMBER_ID]['route']),
        ];
        return view('content.admin.member-roles.create-edit', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('content.admin.member-roles.show', $data);
    }
    ...
    public function destroy($id)
    {
        ...
        \Msg::success($role->name . ' role has been <strong>deleted</strong> ' . \Html::undoLink('admin/member-roles/' . $role->id));
        return redir('admin/member-roles');
    }
